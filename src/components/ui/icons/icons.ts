export const Icons = {
  groups: {
    ...
    class: "mt-1 h-8 w-8 shrink-0 fill-green-500 dark:fill-green-400",
    width: 48,
    height: 48,
  ...
  house: {
    ...
    class: "h-6 w-6 shrink-0 text-neutral-700 hs-tab-active:text-green-400 dark:text-neutral-300 dark:hs-tab-active:text-green-300 md:h-7 md:w-7",
    width: 24,
    height: 24,
    viewBox: "0 0 24 24",
    fill: "none",
  ...
  arrowUp: {
    ...
    class: "h-5 w-5 shrink-0 text-green-400 dark:text-green-300",
    width: 24,
    height: 24,
    viewBox: "0 0 24 24",
    fill: "none",
    ...
    paths: [
      {
        ...
        class:
          "fill-current text-neutral-500 transition duration-300 group-hover:text-green-400 dark:group-hover:text-green-400",
      },
    ],
  ...
  github: {
    paths: [
      {
        d: "M8 0C3.58 0 0 3.58 0 8c0 3.54 2.29 6.53 5.47 7.59.4.07.55-.17.55-.38 0-.19-.01-.82-.01-1.49-2.01.37-2.53-.49-2.69-.94-.09-.23-.48-.94-.82-1.13-.28-.15-.68-.52-.01-.53.63-.01 1.08.58 1.23.82.72 1.21 1.87.87 2.33.66.07-.52.28-.87.51-1.07-1.78-.2-3.64-.89-3.64-3.95 0-.87.31-1.59.82-2.15-.08-.2-.36-1.02.08-2.12 0 0 .67-.21 2.2.82.64-.18 1.98-.27 3-.405 1.02.006 2.04.138 3 .405 2.28-1.552 3.285-1.23 3.285-1.23.645 1.653.24 2.873.12 3.176.765.84 1.23 1.91 1.23 3.22 0 4.61-2.805 5.625-5.475 5.92.42.36.81 1.096.81 2.22 0 1.606-.015 2.896-.015 3.286 0 .315.21.69.825.57C20.565 22.092 24 17.592 24 12.297c0-6.627-5.373-12-12-12",
      },
    ],
    class:
